...
async function displayInfo(){
    const product = await getOneKanap(productID);
    console.log(product);
}
...
async function miseEnPlaceDuProduit() {               // Creation d'une fonction qui permet l'affichage dans la page
    ...
    document.getElementsByClassName("item__img")[0].innerHTML = `<img src="${produits.imageUrl}" alt="${produits.altTxt}">`;  // ***verifier entre produits et products entre les 2 pages le meme ou pas ? 
